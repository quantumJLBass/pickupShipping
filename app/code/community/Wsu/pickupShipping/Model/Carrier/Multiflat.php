 ...
 *
 * @category   Wsu
 * @package    Wsu_pickupShipping
 * @subpackage Multiple Flatrate * @copyright  Copyright (c) 2013 Jeremy Bass  (http://wsu.edu)
 * @author     Jeremy Bass (jeremy.bass@wsu.edu)
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

class Wsu_pickupShipping_Model_Carrier_Multiflat extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{ 
